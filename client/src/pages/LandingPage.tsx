...
const BENEFITS = [
  {
    title: '評議員としての証明',
    body: '千ノ国の評議員であることを示すデジタル会員証を、ご自身の受取用ウォレットで大切に保管いただけます。',
  },
  {
  ...
  return (
    <div className="landing-page">
      <section className="landing-hero">
        <p className="landing-hero__eyebrow">千ノ国</p>
        <h1>評議員デジタル会員証</h1>
        <p className="landing-hero__lead">
          千ノ国にご参加いただく評議員の皆様に向けた、デジタル会員証のお申し込みページです。
        </p>
      ...
      <section className="landing-section">
        ...
        <p>
          評議員デジタル会員証は、千ノ国の評議員であることを証明するために発行するデジタル形式の会員証です。
